                ...
                b := (
                    (
                        ...
                        if __import__("sys").platform == "win32"
                            ...
                            __import__("tty").setcbreak(
                                s, __import__("termios").TCSANOW
                            ),
                            o("\x1b[?25l\x1b[6n"),
                            file.flush(),
                            b := (
                            ...
                            __import__("termios").tcsetattr(
                                s, __import__("termios").TCSANOW, ta
                            ),
                            int(r.groups()[1])
                            if (r := __import__("re").match(r"^\x1b\[(\d*);(\d*)R", b))
                            else 1,
                    ...
                    (
                        [
                            ...
                            for l in (
                                a
                                for b in (
                                    [l[a : a + t] for a in range(0, len(l) + 1, t)]
                                    for l in m[:-1]
                                )
                                for a in b
                            )
    ...
    (
        f := (
            lambda prompt="", interval=5: (
                ...
                if __import__("sys").platform == "win32"
                else __import__("termios").tcsetattr(
                    s, __import__("termios").TCSANOW, ta
                ),
            )[-2]
        ),
